...
*33 fiches, dont 18 interdites en l'état et aucune libérée. Les dossiers de conception correspondants sont dans [`docs/993/`](docs/993/). Tableau engendré par `scripts/render_parts_table.py`, vérifié par `make check`.*
