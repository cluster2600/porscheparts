...
|---|---:|
| couches | 4 349 |
| hauteur de construction | 130,46 mm |
| couches avec region non soutenue | 22 |
| proxy de supports | 6 202,46 mm³ |
| epaisseur locale p01 | 0,800 mm |
| poudre piegee a 1,00 mm | 0,00 mm³ |

![Simulation d'impression LPBF](../../parts/993-body-front-impact-support-alsi10mg-f0-0001/evidence/lpbf-f0/993-body-front-impact-support-alsi10mg-f0-0001-lpbf-geometry-screen.png)
